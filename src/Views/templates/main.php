...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/OCR-P5/PHP-blog-emilie-forteroche/public/assets/style.css">
</head>
...
<header>
    <nav>
        ...
        if (isset($_SESSION['user'])) {
            echo '<a href="index.php?action=showAdminMonitoring">Monitoring</a>';
